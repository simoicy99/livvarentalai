...
export default function AgentDemo() {
  ...
  const escrowMutation = useMutation({
    ...
    onSuccess: (data) => {
      ...
      // invalidate escrow queries to refresh the panel
      queryClient.invalidateQueries({ queryKey: ["/api/escrow", tenant.email] });
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              {generatedMessage && (
                <Card data-testid="generated-message-card">
                  <CardHeader>
                  ...
                  <CardContent>
                    <div className="p-4 rounded-md bg-muted" data-testid="generated-message">
                      <p className="text-sm whitespace-pre-wrap" data-testid="generated-message-text">
